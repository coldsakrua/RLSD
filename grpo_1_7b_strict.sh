#!/bin/bash
#SBATCH -o logs/grpo_1_7b_strict.%j.out
#SBATCH -p GPUA800
#SBATCH --nodes=1
...
#SBATCH --exclude=gpua800n03,gpua800n07,gpua800n14
set -eo pipefail
nvidia-smi
...
OUTPUT_DIR=${OUTPUT_DIR:-${BASE_DIR}/outputs/grpo_1_7b_strict}
RUN_CONFIG=${RUN_CONFIG:-grpo_1_7b_strict}
