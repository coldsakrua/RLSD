...
#SBATCH --exclude=gpua800n26,gpua800n04,gpua800n11,gpua800n15
set -eo pipefail
nvidia-smi
...
OUTPUT_DIR=${OUTPUT_DIR:-${BASE_DIR}/outputs/opsd_8b}
RUN_CONFIG=${RUN_CONFIG:-opsd_8b}
...
# OPSD paper/repo 8b non-thinking defaults, while keeping this repo's length budget.
