#!/bin/bash
#SBATCH -o /gpfs/share/home/2501210611/RLSD/verl_logs/train/cast_4b.%j.out
#SBATCH -p GPUA800
#SBATCH --nodes=1
...
# Strict-split sign-flip RLSD plus wrong-path positive boost; teacher sees reference.
RUN_CONFIG="${RUN_CONFIG:-cast_4b}"
