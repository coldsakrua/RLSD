#!/bin/bash
#SBATCH -o /gpfs/share/home/2501210611/RLSD/verl_logs/train/cast_teacher50_4b_base_full_nogap005.%j.out
#SBATCH -p GPUA800
#SBATCH --nodes=1
...
#SBATCH --exclude=gpua800n12,gpua800n02
...
RUN_CONFIG="${RUN_CONFIG:-cast_teacher50_4b_base_full_nogap005}"
