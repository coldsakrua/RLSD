#!/bin/bash
#SBATCH -o /gpfs/share/home/2501210611/RLSD/verl_logs/train/cast_teacher10_4b_withgap005.%j.out
#SBATCH -p GPUA800
#SBATCH --nodes=1
...
RUN_CONFIG="${RUN_CONFIG:-cast_teacher10_4b_withgap005}"
...
MAX_TEACHER_PROMPT_LENGTH="${MAX_TEACHER_PROMPT_LENGTH:-1024}"
TEACHER_SHAPING_LENGTH_CAP="${TEACHER_SHAPING_LENGTH_CAP:-1024}"
