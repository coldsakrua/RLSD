#!/bin/bash
#SBATCH -o /gpfs/share/home/2501210611/RLSD/verl_logs/train/grpo_opds_4b.%j.out
#SBATCH -p GPUA800
#SBATCH --nodes=1
...
# Pure OPSD-style token-gap shaping with reward.
RUN_CONFIG="${RUN_CONFIG:-grpo_opds_4b}"
ADV_ESTIMATOR="${ADV_ESTIMATOR:-rlsd_grpo}"
REWARD_FUNCTION_NAME="${REWARD_FUNCTION_NAME:-compute_score}"
TOKEN_GAP_LAMBDA="${TOKEN_GAP_LAMBDA:-0.2}"
...
# Batch choice for A800 80GB + Qwen3-4B LoRA + 3072-token responses:
