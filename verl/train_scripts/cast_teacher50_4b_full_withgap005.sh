#!/bin/bash
#SBATCH -o /gpfs/share/home/2501210611/RLSD/verl_logs/cast_teacher50_4b_full_withgap005.%j.out
#SBATCH -p GPUA800
#SBATCH --nodes=1
...
#SBATCH --exclude=gpua800n07,gpua800n09,gpua800n11,gpua800n25,gpua800n23,gpua800n12,gpua800n01
...
RUN_CONFIG="${RUN_CONFIG:-cast_teacher50_4b_full_withgap005}"
