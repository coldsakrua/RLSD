#!/bin/bash
#SBATCH -o /gpfs/share/home/2501210611/RLSD/verl_logs/train/verl_rlrt_4b.%j.out
#SBATCH -p GPUA800
#SBATCH --nodes=1
...
# RLRT: reversed-teacher token weighting on correct rollouts.
RUN_CONFIG="${RUN_CONFIG:-verl_rlrt_4b}"
ADV_ESTIMATOR="${ADV_ESTIMATOR:-rlrt}"
...
TEACHER_PROMPT_MODE="${TEACHER_PROMPT_MODE:-successful_rollout}"
...
VERL_ARGS=(
    ...
    "++algorithm.rlsd.rlrt_weight_clip=${RLRT_WEIGHT_CLIP}"
    "++algorithm.rlsd.rlrt_teacher_context_mode=successful_rollout"
    ...
    "++actor_rollout_ref.actor.clip_ratio_c=${RLRT_DELTA}"
