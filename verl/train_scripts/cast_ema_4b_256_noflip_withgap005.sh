#!/bin/bash
#SBATCH -o /gpfs/share/home/2501210611/RLSD/verl_logs/train/cast_ema_4b_256_noflip_withgap005.%j.out
#SBATCH -p GPUA800
#SBATCH --nodes=1
...
# Strict-split RLSD with EMA teacher, preserving the sign of base advantages.
...
RUN_CONFIG="${RUN_CONFIG:-cast_ema_4b_256_noflip_withgap005}"
