#!/bin/bash
#SBATCH -o /gpfs/share/home/2501210611/RLSD/verl_logs/cast_ema_4b_full_withgt1200(nogap005).%j.out
#SBATCH -p GPUA800
#SBATCH --nodes=1
...
RUN_CONFIG="${RUN_CONFIG:-cast_ema_4b_full_withgt1200(nogap005)}"
