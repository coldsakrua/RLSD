...
from rlsd_sign_flip_wrong_boost_strict_split_trainer import RLSDSignFlipWrongBoostStrictSplitTrainer
...
class ScriptArguments:
    ...
    run_config: str = "rlsd_strict_split_flip_wrong_boost_4b"
    prompt_prefix: str = ""
    prompt_suffix: str = ""
...
def main():
    ...
    trainer = RLSDSignFlipWrongBoostStrictSplitTrainer(
