#!/bin/bash
#SBATCH -o logs/rlsd_1_7b_strict_split_flip_wrong_boost_nodecay_no_teacher_ref_600step.%j.out
#SBATCH -p GPUA800
#SBATCH --nodes=1
...
#SBATCH --exclude=gpua800n09,gpua800n10,gpua800n12,gpua800n25,gpua800n26,gpua800n03,gpua800n04
...
OUTPUT_DIR=${OUTPUT_DIR:-${BASE_DIR}/outputs/rlsd_1_7b_strict_split_flip_wrong_boost_nodecay_no_teacher_ref_600step}
RUN_CONFIG=${RUN_CONFIG:-rlsd_1_7b_strict_split_flip_wrong_boost_nodecay_no_teacher_ref_600step}
