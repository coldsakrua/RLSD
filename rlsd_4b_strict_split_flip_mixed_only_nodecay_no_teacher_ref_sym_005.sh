#!/bin/bash
#SBATCH -o logs/rlsd_4b_strict_split_flip_mixed_only_nodecay_no_teacher_ref_sym_005.%j.out
#SBATCH -p GPUA800
#SBATCH --nodes=1
...
OUTPUT_DIR=${OUTPUT_DIR:-${BASE_DIR}/outputs/rlsd_4b_strict_split_flip_mixed_only_nodecay_no_teacher_ref_sym_005}
RUN_CONFIG=${RUN_CONFIG:-rlsd_4b_strict_split_flip_mixed_only_nodecay_no_teacher_ref_sym_005}
...
CORRECT_WEIGHT_CLIP_LOW=${CORRECT_WEIGHT_CLIP_LOW:-0.95}
CORRECT_WEIGHT_CLIP_HIGH=${CORRECT_WEIGHT_CLIP_HIGH:-1.05}
WRONG_WEIGHT_CLIP_LOW=${WRONG_WEIGHT_CLIP_LOW:-0.95}
WRONG_WEIGHT_CLIP_HIGH=${WRONG_WEIGHT_CLIP_HIGH:-1.05}
...
echo "[clip] correct_weight=[${CORRECT_WEIGHT_CLIP_LOW},${CORRECT_WEIGHT_CLIP_HIGH}] wrong_weight=[${WRONG_WEIGHT_CLIP_LOW},${WRONG_WEIGHT_CLIP_HIGH}]"
