#!/bin/bash
#SBATCH -o logs/eval_32k_hmmt25_06b.%j.out
#SBATCH -p GPUA800
#SBATCH --nodes=1
...
checkpoint_dir=${CHECKPOINT_DIR:-${LORA_PATH:-/gpfs/share/home/2501210611/RLSD/outputs/rlsd_0_6b_strict_split_flip_nodecay_no_teacher_ref/job_1761771/checkpoint-300}}
...
generate_batch_size=${GENERATE_BATCH_SIZE:-30}
...
output_json=${OUTPUT_JSON:-outputs/eval_32k_hmmt25/${_eval_cot_dir}_${_len_tag}/eval_${run_tag}.json}
