#!/bin/bash
#SBATCH -o logs/rlsd_4b_strict_split_150step.%j.out
#SBATCH -p GPUA800
#SBATCH --nodes=1
...
OUTPUT_DIR=${OUTPUT_DIR:-${BASE_DIR}/outputs/rlsd_4b_strict_split_150step}
RUN_CONFIG=${RUN_CONFIG:-rlsd_4b_strict_split_150step}
...
# LMBDA_DECAY_STEPS; lambda_plus/minus decay over FALLBACK_DECAY_STEPS — both 150 here.
LMBDA=${LMBDA:-0.2}
LMBDA_DECAY_STEPS=${LMBDA_DECAY_STEPS:-150}
