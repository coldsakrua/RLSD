#!/bin/bash
#SBATCH -o logs/rlsd_4b_strict_split_flip_full50step_no_teacher_ref.%j.out
#SBATCH -p GPUA800
#SBATCH --nodes=1
...
#SBATCH --exclude=gpua800n14,gpua800n09,gpua800n11
...
OUTPUT_DIR=${OUTPUT_DIR:-${BASE_DIR}/outputs/rlsd_4b_strict_split_flip_full50step_no_teacher_ref}
RUN_CONFIG=${RUN_CONFIG:-rlsd_4b_strict_split_flip_full50step_no_teacher_ref}
