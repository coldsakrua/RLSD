#!/bin/bash
#SBATCH -o logs/verl_grpo_4b_1gpu.%j.out
#SBATCH -p GPUA800
#SBATCH --nodes=1
...
OUTPUT_DIR=${OUTPUT_DIR:-${BASE_DIR}/outputs/verl_grpo_4b_1gpu}
RUN_NAME=${RUN_NAME:-verl_grpo_4b_1gpu}
...
VLLM_MEM_UTIL=${VLLM_MEM_UTIL:-0.55}
