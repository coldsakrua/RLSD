#!/bin/bash
#SBATCH -o logs/rlsd_1_7b_strict_split_flip_nodecay_no_teacher_ref_600step.%j.out
#SBATCH -p GPUA800
#SBATCH --nodes=1
...
#SBATCH --exclude=gpua800n03,gpua800n24,gpua800n14,gpua800n21
set -eo pipefail
nvidia-smi
...
OUTPUT_DIR=${OUTPUT_DIR:-${BASE_DIR}/outputs/rlsd_1_7b_strict_split_flip_nodecay_no_teacher_ref_600step}
RUN_CONFIG=${RUN_CONFIG:-rlsd_1_7b_strict_split_flip_nodecay_no_teacher_ref_600step}
