#!/bin/bash
#SBATCH -o logs/rlsd_4b_strict_split_flip_nodecay_no_teacher_ref_150.%j.out
#SBATCH -p GPUA800
#SBATCH --nodes=1
...
#SBATCH --exclude=gpua800n10,gpua800n06
...
OUTPUT_DIR=${OUTPUT_DIR:-${BASE_DIR}/outputs/rlsd_4b_strict_split_flip_nodecay_no_teacher_ref_150}
RUN_CONFIG=${RUN_CONFIG:-rlsd_4b_strict_split_flip_nodecay_no_teacher_ref_150}
