#!/bin/bash
#SBATCH -o logs/grpo_0_6b_strict.%j.out
#SBATCH -p GPUA800
#SBATCH --nodes=1
...
#SBATCH --exclude=gpua800n24,gpua800n04,gpua800n23
set -eo pipefail
nvidia-smi
...
OUTPUT_DIR=${OUTPUT_DIR:-${BASE_DIR}/outputs/grpo_0_6b_strict}
RUN_CONFIG=${RUN_CONFIG:-grpo_0_6b_strict}
