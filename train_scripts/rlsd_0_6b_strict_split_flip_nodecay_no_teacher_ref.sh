#!/bin/bash
#SBATCH -o logs/rlsd_0_6b_strict_split_flip_nodecay_no_teacher_ref.%j.out
#SBATCH -p GPUA800
#SBATCH --nodes=1
...
#SBATCH --exclude=gpua800n24,gpua800n04,gpua800n07,gpua800n06,gpua800n23,gpua800n03,gpua800n25,gpua800n21
set -eo pipefail
nvidia-smi
...
OUTPUT_DIR=${OUTPUT_DIR:-${BASE_DIR}/outputs/rlsd_0_6b_strict_split_flip_nodecay_no_teacher_ref}
RUN_CONFIG=${RUN_CONFIG:-rlsd_0_6b_strict_split_flip_nodecay_no_teacher_ref}
