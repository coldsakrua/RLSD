#!/bin/bash
#SBATCH -o logs/rlsd_4b_strict_split_nodecay_no_teacher_ref.%j.out
#SBATCH -p GPUA800
#SBATCH --nodes=1
...
OUTPUT_DIR=${OUTPUT_DIR:-${BASE_DIR}/outputs/rlsd_4b_strict_split_nodecay_no_teacher_ref}
RUN_CONFIG=${RUN_CONFIG:-rlsd_4b_strict_split_nodecay_no_teacher_ref}
