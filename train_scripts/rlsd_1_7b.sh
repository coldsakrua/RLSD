...
#SBATCH --exclude=gpua800n04,gpua800n07,gpua800n14,gpua800n24
set -eo pipefail
nvidia-smi
...
OUTPUT_DIR=${OUTPUT_DIR:-${BASE_DIR}/outputs/rlsd_1_7b}
RUN_CONFIG=${RUN_CONFIG:-rlsd_1_7b}
