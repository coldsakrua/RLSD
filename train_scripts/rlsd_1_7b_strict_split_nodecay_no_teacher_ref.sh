#!/bin/bash
#SBATCH -o logs/rlsd_1_7b_strict_split_nodecay_no_teacher_ref.%j.out
#SBATCH -p GPUA800
#SBATCH --nodes=1
...
OUTPUT_DIR=${OUTPUT_DIR:-${BASE_DIR}/outputs/rlsd_1_7b_strict_split_nodecay_no_teacher_ref}
RUN_CONFIG=${RUN_CONFIG:-rlsd_1_7b_strict_split_nodecay_no_teacher_ref}
