#!/bin/bash
#SBATCH -o logs/llama_logs/rlsd_llama3_2_3b_strict_split_flip_wrong_boost_nodecay_no_teacher_ref.%j.out
#SBATCH -p GPUA800
#SBATCH --nodes=1
...
OUTPUT_DIR=${OUTPUT_DIR:-${BASE_DIR}/outputs/rlsd_llama3_2_3b_strict_split_flip_wrong_boost_nodecay_no_teacher_ref}
RUN_CONFIG=${RUN_CONFIG:-rlsd_llama3_2_3b_strict_split_flip_wrong_boost_nodecay_no_teacher_ref}
...
# Llama 3.2 Instruct generation_config commonly uses temperature=0.6, top_p=0.9.
