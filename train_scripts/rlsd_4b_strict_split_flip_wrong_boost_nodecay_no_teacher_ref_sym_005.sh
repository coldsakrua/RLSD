#!/bin/bash
#SBATCH -o logs/rlsd_4b_strict_split_flip_wrong_boost_nodecay_no_teacher_ref_sym_005.%j.out
#SBATCH -p GPUA800
#SBATCH --nodes=1
...
#SBATCH --exclude=gpua800n12,gpua800n09
...
OUTPUT_DIR=${OUTPUT_DIR:-${BASE_DIR}/outputs/rlsd_4b_strict_split_flip_wrong_boost_nodecay_no_teacher_ref_sym_005}
RUN_CONFIG=${RUN_CONFIG:-rlsd_4b_strict_split_flip_wrong_boost_nodecay_no_teacher_ref_sym_005}
