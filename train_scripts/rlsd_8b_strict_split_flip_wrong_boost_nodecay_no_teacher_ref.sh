#!/bin/bash
#SBATCH -o logs/rlsd_8b_strict_split_flip_wrong_boost_nodecay_no_teacher_ref.%j.out
#SBATCH -p GPUA800
#SBATCH --nodes=1
...
#SBATCH --exclude=gpua800n09,gpua800n10,gpua800n12,gpua800n25,gpua800n26,gpua800n03
...
OUTPUT_DIR=${OUTPUT_DIR:-${BASE_DIR}/outputs/rlsd_8b_strict_split_flip_wrong_boost_nodecay_no_teacher_ref}
RUN_CONFIG=${RUN_CONFIG:-rlsd_8b_strict_split_flip_wrong_boost_nodecay_no_teacher_ref}
