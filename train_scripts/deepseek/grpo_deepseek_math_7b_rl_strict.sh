#!/bin/bash
#SBATCH -o logs/deepseek_logs/grpo_deepseek_math_7b_rl_strict.%j.out
#SBATCH -p GPUA800
#SBATCH --nodes=1
...
#SBATCH --exclude=gpua800n26,gpua800n03
...
OUTPUT_DIR=${OUTPUT_DIR:-${BASE_DIR}/outputs/grpo_deepseek_math_7b_rl_strict}
RUN_CONFIG=${RUN_CONFIG:-grpo_deepseek_math_7b_rl_strict}
