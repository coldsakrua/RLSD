...
#SBATCH --exclude=gpua800n24,gpua800n04,gpua800n23,gpua800n21
set -eo pipefail
nvidia-smi
...
OUTPUT_DIR=${OUTPUT_DIR:-${BASE_DIR}/outputs/rlsd_0_6b}
RUN_CONFIG=${RUN_CONFIG:-rlsd_0_6b}
