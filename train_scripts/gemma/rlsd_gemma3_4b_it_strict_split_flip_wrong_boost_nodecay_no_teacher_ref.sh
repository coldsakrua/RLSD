#!/bin/bash
#SBATCH -o logs/gemma_logs/rlsd_gemma3_4b_it_strict_split_flip_wrong_boost_nodecay_no_teacher_ref.%j.out
#SBATCH -p GPUA800
#SBATCH --nodes=1
...
#SBATCH --exclude=gpua800n07,gpua800n02,gpua800n12
...
MODEL_PATH=${MODEL_PATH:-/gpfs/share/home/2501210611/labShare/2501210611/model/gemma-3-4b-it}
...
OUTPUT_DIR=${OUTPUT_DIR:-${BASE_DIR}/outputs/rlsd_gemma3_4b_it_strict_split_flip_wrong_boost_nodecay_no_teacher_ref}
RUN_CONFIG=${RUN_CONFIG:-rlsd_gemma3_4b_it_strict_split_flip_wrong_boost_nodecay_no_teacher_ref}
