#!/bin/bash
#SBATCH -o logs/gemma_logs/grpo_gemma3_4b_it_strict.%j.out
#SBATCH -p GPUA800
#SBATCH --nodes=1
...
OUTPUT_DIR=${OUTPUT_DIR:-${BASE_DIR}/outputs/grpo_gemma3_4b_it_strict}
RUN_CONFIG=${RUN_CONFIG:-grpo_gemma3_4b_it_strict}
