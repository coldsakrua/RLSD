#!/bin/bash
#SBATCH -o logs/gemma_logs/rlsd_gemma3_4b_it_paper.%j.out
#SBATCH -p GPUA800
#SBATCH --nodes=1
...
OUTPUT_DIR=${OUTPUT_DIR:-${BASE_DIR}/outputs/rlsd_gemma3_4b_it_paper}
RUN_CONFIG=${RUN_CONFIG:-rlsd_gemma3_4b_it_paper}
