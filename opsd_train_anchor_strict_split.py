...
from rlsd_sign_fallback_strict_split_trainer import RLSDSignFallbackStrictSplitTrainer
...
class ScriptArguments:
    ...
    run_config: str = "rlsd_strict_split_4b"
    prompt_prefix: str = ""
    prompt_suffix: str = ""
...
def main():
    ...
    trainer = RLSDSignFallbackStrictSplitTrainer(
