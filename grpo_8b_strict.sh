#!/bin/bash
#SBATCH -o logs/grpo_8b_strict.%j.out
#SBATCH -p GPUA800
#SBATCH --nodes=1
...
#SBATCH --exclude=gpua800n15,gpua800n04,gpua800n07,gpua800n11
...
OUTPUT_DIR=${OUTPUT_DIR:-${BASE_DIR}/outputs/grpo_8b_strict}
RUN_CONFIG=${RUN_CONFIG:-grpo_8b_strict}
