#!/bin/bash
#SBATCH -o logs/rlsd_4b_strict_split_flip_wrong_boost_nodecay_no_teacher_ref_adv_abs_0p5.%j.out
#SBATCH -p GPUA800
#SBATCH --nodes=1
...
OUTPUT_DIR=${OUTPUT_DIR:-${BASE_DIR}/outputs/rlsd_4b_strict_split_flip_wrong_boost_nodecay_no_teacher_ref_adv_abs_0p5}
RUN_CONFIG=${RUN_CONFIG:-rlsd_4b_strict_split_flip_wrong_boost_nodecay_no_teacher_ref_adv_abs_0p5}
...
ALL_CORRECT_BASE_ADVANTAGE=${ALL_CORRECT_BASE_ADVANTAGE:-0.5}
ALL_WRONG_BASE_ADVANTAGE=${ALL_WRONG_BASE_ADVANTAGE:--0.5}
