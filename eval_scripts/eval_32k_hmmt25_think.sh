#!/bin/bash
#SBATCH -o /gpfs/share/home/2501210611/RLSD/logs/eval_32k_hmmt25_think.%j.out
#SBATCH -p GPUA800
#SBATCH --nodes=1
...
checkpoint_dir=${CHECKPOINT_DIR:-${LORA_PATH:-/gpfs/share/home/2501210611/RLSD/outputs/cast_ema_4b_256(nogap005)/job_2182214/global_step_300/actor/lora_adapter}}
...
output_json=${OUTPUT_JSON:-outputs/eval_32k_hmmt25/cot_38912/eval_${run_tag}.json}
