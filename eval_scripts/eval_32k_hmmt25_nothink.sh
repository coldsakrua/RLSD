#!/bin/bash
#SBATCH -o /gpfs/share/home/2501210611/RLSD/logs/eval_32k_hmmt25_nothink.%j.out
#SBATCH -p GPUA800
#SBATCH --nodes=1
...
output_json=${OUTPUT_JSON:-outputs/eval_32k_hmmt25/no_cot_32k/eval_${run_tag}.json}
