...
#SBATCH --exclude=gpua800n24,gpua800n04,gpua800n03,gpua800n21,gpua800n25,gpua800n23,gpua800n06
...
OUTPUT_DIR=${OUTPUT_DIR:-${BASE_DIR}/outputs/opsd_0_6b}
RUN_CONFIG=${RUN_CONFIG:-opsd_0_6b}
