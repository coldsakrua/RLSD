#!/bin/bash
#SBATCH -o logs/rlsd_4b_strict_split_nodecay.%j.out
#SBATCH -p GPUA800
#SBATCH --nodes=1
...
#SBATCH --exclude=gpua800n06,gpua800n04,gpua800n09
...
OUTPUT_DIR=${OUTPUT_DIR:-${BASE_DIR}/outputs/rlsd_4b_strict_split_nodecay}
RUN_CONFIG=${RUN_CONFIG:-rlsd_4b_strict_split_nodecay}
