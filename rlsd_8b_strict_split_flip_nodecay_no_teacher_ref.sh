#!/bin/bash
#SBATCH -o logs/rlsd_8b_strict_split_flip_nodecay_no_teacher_ref.%j.out
#SBATCH -p GPUA800
#SBATCH --nodes=1
...
#SBATCH --exclude=gpua800n06,gpua800n23
set -eo pipefail
nvidia-smi
...
OUTPUT_DIR=${OUTPUT_DIR:-${BASE_DIR}/outputs/rlsd_8b_strict_split_flip_nodecay_no_teacher_ref}
RUN_CONFIG=${RUN_CONFIG:-rlsd_8b_strict_split_flip_nodecay_no_teacher_ref}
